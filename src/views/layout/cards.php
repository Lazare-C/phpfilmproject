            ...
            <article class="w-4/5 bg-white group relative rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transform duration-200">
                ...
                <div class="px-3 py-4">
                    <h3 class="text-sm text-gray-500 pb-2">
                        <h5 class="text-gray-900 font-bold text-2xl tracking-tight mb-2 dark:text-white"><?echo $name?></h5>
                    </h3>
                    <p class="font-normal text-gray-700 mb-3 dark:text-gray-400">Note : <?echo $score?></p>
