            ...
            <div class="lg:w-2/5 md:w-1/2 w-2/3">
                <form class="bg-white p-10 rounded-lg shadow-lg min-w-full" method="post"  enctype="multipart/form-data" >
                    ...
                    <div>
                        ...
                        <input required class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none" value="<?php echo $GLOBALS['film']->getNbVote(); ?>" type="number" name="nb_vote" id="nb_vote" placeholder="Nombre de Vote"  />
                    </div>
                    <div>
